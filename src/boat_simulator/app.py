...
# save_screenshot, build_run_screenshot_figure, build_sweep_screenshot_figure,
# and build_convergence_screenshot_figure are imported from visualization.figures
